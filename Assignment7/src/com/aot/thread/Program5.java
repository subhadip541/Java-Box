...
public class Program5 {
	...
	public static void main(String[] args) {
		...
		MyRunnable2 t2 = new MyRunnable2("Thread1", 1);
		MyRunnable2 t3 = new MyRunnable2("Thread1", 2);
		MyRunnable2 t4 = new MyRunnable2("Thread1", 4);
		MyRunnable2 t5 = new MyRunnable2("Thread1", 3);
		System.out.println("Thread1 is Alive-" + t1.isAlive());
		System.out.println("Thread1 is Alive-" + t2.isAlive());
		System.out.println("Thread1 is Alive-" + t3.isAlive());
		System.out.println("Thread1 is Alive-" + t4.isAlive());
		System.out.println("Thread1 is Alive-" + t5.isAlive());
